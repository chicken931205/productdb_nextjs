...
const FAQItem = ({ faqData }: { faqData: FaqData }) => {
  ...
  return (
    <div
      className="mb-4 flex flex-col border dark:border-strokedark"
    ...
    >
      <button
        ...
        className="flex cursor-pointer items-center justify-between px-6 py-3.5 text-sm font-medium text-black dark:text-white lg:px-4 lg:py-4"
      >
        {quest}
        {activeFaq === id ? (
          <svg
      ...
      <p
        className={` px-4 text-sm py-4 dark:border-strokedark lg:px-4 lg:py-4 ${
